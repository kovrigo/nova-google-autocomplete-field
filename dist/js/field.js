...
Nova.booting(function (Vue, router) {
    Vue.component('index-google-autocomplete', __webpack_require__(4));
    Vue.component('detail-google-autocomplete', __webpack_require__(7));
    Vue.component('form-google-autocomplete', __webpack_require__(10));

    Vue.component('index-address-metadata', __webpack_require__(16));
    Vue.component('detail-address-metadata', __webpack_require__(19));
    Vue.component('form-address-metadata', __webpack_require__(22));
});
    ...
    methods: {
        ...
        getAddressData: function getAddressData(addressData, placeResultData) {
            ...
            this.field.addressObject.forEach(function (element) {
                ...
                var res = _.find(placeResultData.address_components, function (addressComponent) {
...
var update = __webpack_require__(26)("6eae5303", content, false, {});
